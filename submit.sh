...
#sbatch runalgo_rware.sh ippo_ns rware:rware-small-4ag-v1 0.2 False 0.0
#sbatch runalgo_rware.sh ippo_ns rware:rware-small-4ag-v1 0.5 False 0.0
#sbatch runalgo_rware.sh ippo_ns rware:rware-small-4ag-v1 0.2 True 0.1
#sbatch runalgo_rware.sh ippo_ns rware:rware-small-4ag-v1 0.2 True 0.01
...
sbatch runalgo_smac.sh ippo_ns_smac corridor 0.2 False 0.0
sbatch runalgo_smac.sh ippo_ns_smac corridor 0.5 False 0.0
sbatch runalgo_smac.sh ippo_ns_smac corridor 0.2 True 0.001
