...
sbatch runalgo_rware.sh ippo_t_ns_rware rware:rware-small-4ag-v1 0.2 False 0.0
sbatch runalgo_rware.sh ippo_t_ns_rware rware:rware-tiny-4ag-v1 0.2 False 0.0
sbatch runalgo_rware.sh ippo_t_ns_rware rware:rware-tiny-2ag-v1 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac 2s3z 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac 3s5z 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac 3s5z 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac corridor 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac MMM2 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac 6h_vs_8z 0.2 False 0.0
sbatch runalgo_smac.sh ippo_t_ns_smac 3s5z_vs_3s6z 0.2 False 0.0
